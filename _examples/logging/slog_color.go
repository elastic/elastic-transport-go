...
// NewColorLogger creates a *slog.Logger that produces ANSI-colored terminal
// output similar to the deprecated [elastictransport.ColorLogger].
//
// Legacy ColorLogger output:
//
//	   GET http://localhost:9200/ 200 OK 5ms
//
// This logger colors the level and status code: green for 2xx, yellow for
// 3xx/4xx, red for 5xx and errors.
func NewColorLogger(w io.Writer) *slog.Logger {
	return slog.New(&colorHandler{w: w})
}
...
func (h *colorHandler) Handle(_ context.Context, r slog.Record) error {
	...
	// Print record attrs, coloring status codes
